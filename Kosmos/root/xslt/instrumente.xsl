  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <xsl:element name="a">
        ...
        <xsl:attribute name="href">http://www.deutschestextarchiv.de/search?in=text&amp;limit=100&amp;q=<xsl:value-of select="k:urlencode(text())"/>+%23has%5Bflags%2C%2Favhkv%2F%5D</xsl:attribute>
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <xsl:element name="a">
        ...
        <xsl:attribute name="href">http://www.deutschestextarchiv.de/search?in=text&amp;limit=100&amp;q=<xsl:value-of select="k:urlencode(text())"/>+%23has%5Bauthor%2C%2Fhumboldt%2Fi%5D</xsl:attribute>
